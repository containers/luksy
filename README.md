lukstool: offline encryption/decryption using LUKS formats [![Cirrus CI Status](https://img.shields.io/cirrus/github/nalind/lukstool/main)](https://cirrus-ci.com/github/nalind/lukstool/main)
-
